...
public class UgaBuga {
    ...
    public static void main(String[] args) {
        ...
        for (int index = 0; index < TIMES; index++) {
            ...
            // assertion
            Assertions.assertTrue(ToriaMath.areEqual(len11, len21));
            Assertions.assertTrue(ToriaMath.areEqual(len12, len22));
            Assertions.assertTrue(ToriaMath.areEqual(len13, len23));
            Assertions.assertTrue(ToriaMath.areEqual(len14, len24));
            Assertions.assertTrue(ToriaMath.areEqual(len15, len25));
            Assertions.assertTrue(ToriaMath.areEqual(len16, len26));
            Assertions.assertTrue(ToriaMath.areEqual(len17, len27));
            Assertions.assertTrue(ToriaMath.areEqual(len18, len28));
            Assertions.assertTrue(ToriaMath.areEqual(sum11, sum21));
            Assertions.assertTrue(ToriaMath.areEqual(sum12, sum22));
            Assertions.assertTrue(ToriaMath.areEqual(sum13, sum23));
            Assertions.assertTrue(ToriaMath.areEqual(sum14, sum24));
            Assertions.assertTrue(ToriaMath.areEqual(sum15, sum25));
            Assertions.assertTrue(ToriaMath.areEqual(sum16, sum26));
            Assertions.assertTrue(ToriaMath.areEqual(sum17, sum27));
            Assertions.assertTrue(ToriaMath.areEqual(sum18, sum28));
        }
