...
public class JOMLMatrixVsToriaMatrix {
    ...
    static void mat4Benchmark() {
        ...
        int jomlIndex = 0;
        double[] toriaTimes = new double[TIMES];
        int toriaIndex = 0;
        for (int unused = 0; unused < TIMES; unused++) {
            ...
            // JOML
            // TORIA
            long toriaStart = System.nanoTime();
        ...
        Arrays.sort(toriaTimes);
        System.out.println("Toria:");
        System.out.println(DescStats.getDataDesc(toriaTimes));
        System.out.println();
