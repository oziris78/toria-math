...
public class TwoVarFuncTest {
    ...
    void twoVarFuncTest() {
        ...
        Assertions.assertTrue(ToriaMath.areEqual(z1.value(1, 2), 1d + 4d));
        Assertions.assertTrue(ToriaMath.areEqual(z1.value(-1, 2.5), 1d + 2.5d * 2.5d));

        TwoVarFunc z2 = new TwoVarFunc(new TRange(1, 2), new TRange(1.5d, 1.75d), (x,y) -> x + y);
        Assertions.assertTrue(ToriaMath.areEqual(z2.value(1, 1.5d), 2.5d));
        Assertions.assertTrue(ToriaMath.areEqual(z2.value(0.99d, 1.5d), 0));
        Assertions.assertTrue(ToriaMath.areEqual(z2.value(2.01d, 1.5d), 0));
        Assertions.assertTrue(ToriaMath.areEqual(z2.value(1d, 1.76d), 0));
