...
public class ComplexNumberTest {
    ...
    void complexNumTest() {
        ...
        Assertions.assertEquals(ToriaMath.areEqual(c1.distanceFromOrigin(), Math.sqrt(8)), true);
        Assertions.assertEquals(ToriaMath.areEqual(c2.distanceFromOrigin(), Math.sqrt(8)), true);
        Assertions.assertEquals(ToriaMath.areEqual(c3.distanceFromOrigin(), 8), true);
