...
public class TLine2DTest {
    ...
    public static void main(String[] args) {
...

        {
            ...
            System.out.println(TLine2D.angleBetweenTwoLines(line2, line1) * 180d / TMathConstants.PI);
            System.out.println(TLine2D.angleBetweenTwoLines(line3, line1) * 180d / TMathConstants.PI);
            System.out.println(TLine2D.angleBetweenTwoLines(line4, line1) * 180d / TMathConstants.PI);
            System.out.println(TLine2D.angleBetweenTwoLines(line3, line2) * 180d / TMathConstants.PI);
            System.out.println(TLine2D.angleBetweenTwoLines(line4, line2) * 180d / TMathConstants.PI);
            System.out.println(TLine2D.angleBetweenTwoLines(line4, line3) * 180d / TMathConstants.PI);
        }
