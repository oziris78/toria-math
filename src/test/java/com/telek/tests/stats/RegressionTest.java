...
import com.telek.telekmath.advanced.statistics.regression.Regression;
...
//        RegressionResult res2 = new Regression(arr2).getRegressionResult();
        ...
        // tpoint2d array
        TPoint2D[] arr3 = getPointArr();
        RegressionResult res3 = new Regression(arr3).getRegressionResult();
