...
public final class TMath {
    ...
    public static int permutation(int n, int r){
        ...
        return TMath.factorialInt(n) / TMath.factorialInt(n - r);
    }
    ...
    public static int repeatedPermutation(int n, int... rValues){
        ...
        int result = TMath.factorialInt(n);
        for(int r : rValues) result /= TMath.factorialInt(r);
        return result;
    }
    ...
    public static int combination(int n, int r){
        ...
        return TMath.factorialInt(n) / (TMath.factorialInt( n - r ) * TMath.factorialInt(r));
    }
