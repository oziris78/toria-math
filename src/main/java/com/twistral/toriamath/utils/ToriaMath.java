 ...
 * many ways to fit toria-math. <br>
...
public final class ToriaMath {
    ...
    public static int factorialInt(int num){
        return (num != 0) ? num * factorialInt(num-1) : 1;
    }
    ...
    public static int permutation(int n, int r){
        ...
        return ToriaMath.factorialInt(n) / ToriaMath.factorialInt(n - r);
    }
    ...
    public static int repeatedPermutation(int n, int... rValues){
        ...
        int result = ToriaMath.factorialInt(n);
        for(int r : rValues) result /= ToriaMath.factorialInt(r);
        return result;
    }
    ...
    public static int combination(int n, int r){
        ...
        return ToriaMath.factorialInt(n) / (ToriaMath.factorialInt( n - r ) * ToriaMath.factorialInt(r));
    }
    ...
    public static boolean areEqual(double d1, double d2){
        ...
        return Math.abs(d1 - d2) < TMathConsts.EPSILON;
    }
     ...
     */
    public static float asinFloat(float a) {
     ...
     */
    public static float acosFloat(float a) {
        float a2 = a * a;  // a squared
        float a3 = a * a2; // a cubed
        if (a >= 0f) {
    ...
    public static double regularizedBeta(double x, double funcAlpha, double funcBeta) {
        ...
        return ToriaMath.exp((funcAlpha * ToriaMath.log(x)) + (funcBeta * ToriaMath.log(1.0 - x)) - ToriaMath.log(funcAlpha) - ToriaMath.logBeta(funcAlpha, funcBeta)) *
                1d / c;
    ...
    public static double logGamma(double x) {
        if (Double.isNaN(x) || (x <= 0.0)) {
            ...
            return ( (x + .5) * Math.log(tmp) ) - tmp + TMathConsts.HALF_LOG_2_PI + Math.log(sum / x);
        }
    }
    ...
    private static final class ApacheArrays {
