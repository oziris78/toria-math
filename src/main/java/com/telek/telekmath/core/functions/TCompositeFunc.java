 ...
 */
public class TCompositeFunc extends AbstractFunction {
    ...
    public TCompositeFunc(ArrayList<AbstractFunction[]> innerProducts){
        super(TRange.REEL_NUMBERS);
        this.innerProducts = innerProducts;
    }

    public TCompositeFunc(AbstractFunction... functions){
        this(new ArrayList<>());
    ...
    private TCompositeFunc deriveProduct(AbstractFunction[] product) {
