 ...
 */
public class TCompositeFunc extends AbstractSingleVarFunc {
    ...
    public TCompositeFunc(ArrayList<AbstractSingleVarFunc[]> innerProducts){
        super(TRange.REEL_NUMBERS);
        this.innerProducts = innerProducts;
    }


    public TCompositeFunc(AbstractSingleVarFunc... functions){
        this(new ArrayList<>());
    ...
    private TCompositeFunc deriveProduct(AbstractSingleVarFunc[] product) {
